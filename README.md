...
- [x] **Runespeech (2026-08-01):** TODAS as palavras mágicas da CipSoft substituídas por idioma próprio — dicionário completo em `docs/runespeech.md` (67 raízes, mapeamento bijetivo, ex.: exura→veyra, exori→korva, utevo lux→genva luma). Aplicado no servidor (197 arquivos Lua, `:words(...)`) e no cliente (`modules/gamelib/spells.lua`, 186 magias). Inclui comandos de casa (aleta/alana→senda/voska). Magia nova = usar só raízes do dicionário. Boot limpo no PC e na VPS.
